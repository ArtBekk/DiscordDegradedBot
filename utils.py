...
links_map = {
    "metro": "https://msk.metro-cc.ru/category/bakaleya/produkty-bystrogo-prigotovleniya/lapsha-govyadina-doshirak-90g-488492",
...
def lenta_get_price(url: str):
    ...
    return {
        'marketName': "Lenta",
        'message': f"Beef doshirak's price in Lenta for bums w/o the card: {regular_price[0]},{regular_price[1]}{regular_price[2]} and price for kings with "
                   f"the card: {card_price[0]},{card_price[1]}{card_price[2]}",
        'price': float(f"{card_price[0]}.{card_price[1]}"),
        'URL': url
    }
